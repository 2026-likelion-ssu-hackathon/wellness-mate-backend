...
5. 작업 브랜치의 의미 있는 개별 커밋은 유지하되, 의미 없는 중간 커밋이 남지 않도록 정리합니다.
6. 리뷰와 CI가 완료되면 PR에서 **Create a merge commit** 방식으로 `main`에 병합합니다.
7. 병합 후 원격 작업 브랜치를 삭제합니다.
